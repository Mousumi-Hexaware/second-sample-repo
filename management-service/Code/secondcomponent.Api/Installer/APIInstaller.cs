...
using ElmahCore.Mvc;
using ElmahCore;
using secondcomponent.Api.Filters;
using secondcomponent.Business.Installer;

namespace secondcomponent.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "secondcomponent API", Version = version + "-" + branch});
            });
