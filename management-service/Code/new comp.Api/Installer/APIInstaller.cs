...
using ElmahCore.Mvc;
using ElmahCore;
using new comp.Api.Filters;
using new comp.Business.Installer;

namespace new comp.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "new comp API", Version = version + "-" + branch});
            });
