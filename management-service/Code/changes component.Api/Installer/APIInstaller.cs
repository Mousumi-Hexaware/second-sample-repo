...
using ElmahCore.Mvc;
using ElmahCore;
using changes component.Api.Filters;
using changes component.Business.Installer;

namespace changes component.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "changes component API", Version = version + "-" + branch});
            });
